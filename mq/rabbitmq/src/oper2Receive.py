...
def main():
    ...
    channel.queue_declare(queue='OPER2',durable=True)
    ...
    def callback(ch, method, properties, body):
        ...
        cur.execute("INSERT INTO oper2 (id, CARRIL,FECHA,HORA_PLAZA,ANTENA,TAG,ESTATUS,CRUCE,EJE,RODADA,CLASE,EVENTO_CARRIL,T_VEHICULO,TURNO,SENTIDO,FECHA_HORA_UTC,SYS_DATE) values (2,"+sqlValues+")");

        con.commit()

    channel.basic_consume(queue='OPER2', on_message_callback=callback, auto_ack=True)
